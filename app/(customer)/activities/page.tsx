                ...
                <Card className="p-4">
                    <CardHeader>
                        <div className="flex justify-between">
                            ...
                            <Link href={"/activities/new"} className="flex items-center justify-center hover:bg-primary transition-color rounded-md border-2 border-dashed border-primary bg-accent p-2 w-1/5">
                                Create Activity
                            </Link>
                        </div>
                    </CardHeader>
